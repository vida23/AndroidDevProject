...
class FAQFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dataset:Array<FAQ> = arrayOf(
            FAQ("TELL ME WHY","NICOLAS CAGEfhdghdgfgfgfgfsg fdsfdsgsg d dfgfd hgfdgdf gd g fdgdf gfd gfd gfd g"),
            FAQ("WHY AM I HERE","Because nice")
        )

        viewManager = LinearLayoutManager(context)

        viewAdapter = FAQRecyclerViewAdapter(dataset,context!!)
